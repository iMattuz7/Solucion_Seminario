...
namespace Nop.Web.Controllers
{
    public partial class CatalogController : BasePublicController
    {
        ...
        public ActionResult CategoryAPI(int categoryId, CatalogPagingFilteringModel command)
        {
            ...
            return Json(new { categories = model }, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult ProductEmailAFriend(int productId)
        {
            ...
            //Por el momento redirecciona al homePage
            return RedirectToRoute("HomePage");
